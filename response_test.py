...
dc_resp = AddLoanDataColEntry(**add_loan_data_column_args_1)
print(f"DATA COLUMN ENTRY: {dc_resp}\n")

dc_cols_resp = AddLoanDataCols(*add_loan_data_columns_list)
print(f"DATA COLS:\n{dc_cols_resp}\n")

val_resp = AddLoanValueEntry(**add_loan_value_entry_2)
print(f"ROW DATA VALUE: {val_resp}\n")

val_col_resp = AddLoanRowColsValue(*add_loan_col_values_list_1)
